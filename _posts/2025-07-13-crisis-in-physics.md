...
General relativity predicts gravitational wave signals
that LIGO measures to extraordinary precision.
...
## I. The Standard Model — A Fifty-Year-Old Theory

The Standard Model was essentially complete by 1973.

Quantum chromodynamics: 1973.
Electroweak unification: 1967-68 (Weinberg, Salam, Glashow).
The full gauge group $$SU(3) \times SU(2) \times U(1)$$:
confirmed by 1973.

The Higgs mechanism: proposed 1964.
The Higgs boson: discovered 2012.

Between 1973 and 2012:
**39 years of experimental confirmations
...
Each discovery confirmed the Standard Model.
None extended it.
...
It has 25 free parameters with no explanation.
It does not explain dark matter or dark energy.
It does not explain the matter-antimatter asymmetry.
It does not explain the hierarchy problem.
It does not explain neutrino masses properly.

We know it is incomplete.
We do not know how to extend it.

---

## II. The LHC — What We Expected and What We Found

The Large Hadron Collider began operations in 2008.
It reached design energy (13 TeV) in 2015.

It cost approximately **$10 billion.**
It involves **10,000 scientists**
from over 100 countries.
It is the most expensive and complex
scientific instrument ever built.

**What we expected to find:**

The theoretical physics community,
in 2008, had strong expectations.

**1. The Higgs boson.**

The Standard Model required it.
The electroweak precision data
constrained its mass to $$< 200$$ GeV.
It was expected. It was found.
...
the lightest stop quark at $$\sim 200-500$$ GeV.
...
The full Run 1 (2011-2012) and Run 2 (2015-2018)
dataset, representing $$\sim 150$$ fb$$^{-1}$$
of proton-proton collisions at 13 TeV:

**One discovery: the Higgs boson.
Everything else: null results.**

---

## III. What the Null Results Mean

Let me be precise about what has been excluded.

**Supersymmetry:**

Current exclusion limits (approximate, model-dependent):

| Particle | Lower mass limit |
|---|---|
| Gluino $$\tilde{g}$$ | $$> 2.2$$ TeV |
| Squark (light flavor) $$\tilde{q}$$ | $$> 1.8$$ TeV |
| Stop $$\tilde{t}_1$$ | $$> 1.1$$ TeV |
| Sbottom $$\tilde{b}_1$$ | $$> 1.3$$ TeV |
| Chargino $$\tilde{\chi}^\pm_1$$ | $$> 700$$ GeV |
| Neutralino $$\tilde{\chi}^0_1$$ | $$> 200$$ GeV |

These are not exclusions of SUSY.
They are exclusions of SUSY **at the TeV scale.**

SUSY could still exist at higher masses.
But higher-mass SUSY does not solve
the hierarchy problem naturally.

**Quantifying the fine-tuning:**

The electroweak fine-tuning in SUSY:

$$\Delta_{EW} \equiv \max_i \left|\frac{\partial \ln m_Z^2}{\partial \ln p_i}\right|$$

where $$p_i$$ are the SUSY parameters.

For a stop at $$m_{\tilde{t}} = 1$$ TeV:
$$\Delta_{EW} \sim 100$$
(1% fine-tuning)
...
With current bounds, SUSY requires fine-tuning
at the percent level or worse.

The solution has become a smaller version of the problem.
...
## IV. String Theory — The Promise and the Problem

String theory is the dominant framework
for quantum gravity.
...
extraordinarily rich and consistent.

Finiteness of string amplitudes
...
The landscape means string theory
does not uniquely predict the Standard Model.
...
accessible to any foreseeable experiment.
...
String theory, as currently formulated, is not.
...
**Wigner's Friend experiments (2019-present):**

Implementations of extended Wigner's Friend scenarios
using photonic systems
probe the consistency of quantum mechanics
across multiple observers.

Results: consistent with quantum mechanics,
but the specific implications depend
...
GRW and related objective collapse models
predict small deviations from standard QM
for large superpositions.

These are being tested with
matter-wave interferometry (Arndt group, Vienna),
...
$$R_K = \frac{\mathcal{B}(B \to K\mu^+\mu^-)}{\mathcal{B}(B \to Ke^+e^-)}$$

$$R_{K^*} = \frac{\mathcal{B}(B \to K^*\mu^+\mu^-)}{\mathcal{B}(B \to K^*e^+e^-)}$$

SM prediction: $$R_K = R_{K^*} = 1$$ (lepton universality).

Previous LHCb measurements: $$R_K \approx 0.85$$ ($$3.1\sigma$$ deviation).

**Update (2022):** LHCb updated their analysis
with improved methodology.
New result: $$R_K = 0.994^{+0.090}_{-0.082}$$
...
Anomalies appear and disappear.
Extraordinary claims require extraordinary systematic control.
The history of particle physics is littered
...
## VIII. The Hubble Tension

One of the most significant current tensions:

**The Hubble constant $$H_0$$:**

**CMB measurements (Planck 2018):**
$$H_0 = 67.4 \pm 0.5 \text{ km/s/Mpc}$$
(early universe, $$z \sim 1100$$)

**Local distance ladder (SH0ES, 2022):**
$$H_0 = 73.04 \pm 1.04 \text{ km/s/Mpc}$$
(late universe, $$z \lesssim 1$$)
...
1. Systematic error in one or both measurements.
...
LIGO/Virgo have detected $$\sim 100$$ gravitational wave events.
...
Neutrino oscillations are established.
The mixing parameters are being measured precisely.
...
The $$\Lambda$$CDM model fits CMB, BAO,
...
No confirmed extension of the Standard Model.
No confirmed quantum gravity theory.
No explanation of dark matter.
No explanation of dark energy.
No explanation of the baryon asymmetry.
No solution to the measurement problem.
No derivation of the constants of nature.
...
Whether this points to a new formulation
...
In 1900, physicists knew what the problems were:
the blackbody spectrum, the photoelectric effect,
...
Today's problems are less specific.

"We need to unify gravity with quantum mechanics."
"We need to explain dark matter."
"We need to explain the constants."

These are real problems.
But they do not point to specific solutions
the way the 1900 problems did.
...
that will crack the current framework open
and reveal the path to the next one.
