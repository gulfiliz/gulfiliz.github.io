...
<div class="row">
    <div class="col-md-6">
        <img src="{{ '/assets/img/new_orleans/french_quarter.JPG' | relative_url }}" class="img-fluid rounded z-depth-1" style="width: 100%; height: 450px; object-fit: cover;" alt="French Quarter">
    </div>
    <div class="col-md-6">
