...
who in 105 CE presented Emperor He with a new writing material
made from bark, hemp, rags, and fishnets.
...
By the time Gutenberg invented movable type in 1440,
paper was ready for it.
...
it is the kind of coincidence that shapes a culture.
Paper in Japan was sacred material.
...
using traditional techniques that have changed little in a thousand years.
...
Some versions say: you will be healed of illness.
...
She began folding cranes in the hospital,
aiming for one thousand.

She folded 644 before she died.
Her classmates completed the remaining 356.

She was twelve years old.

There is a statue of Sadako in the Hiroshima Peace Memorial Park.
She holds a golden crane.
...
In 1989, Humiaki Huzita formalized the operations
possible with a single fold. Later extended by Koshiro Hatori,
the complete set of **seven axioms** defines what can be constructed by folding.

Remarkably: origami is more powerful than compass-and-straightedge construction.
With origami, you can:
- Trisect an angle (impossible with compass and straightedge)
- Double a cube (impossible with compass and straightedge)
- Solve certain cubic equations

The fold is a more powerful geometric operation
than the compass arc or the straight line.

**Flat-foldability:**

When does a crease pattern fold flat?

Two necessary and sufficient conditions for a single vertex:

1. **Kawasaki's theorem:** At any interior vertex,
the alternating sum of angles equals zero:
$$\alpha_1 - \alpha_2 + \alpha_3 - \alpha_4 + \cdots = 0$$

2. **Maekawa's theorem:** At any interior vertex,
the number of mountain folds and valley folds
...
In 1970, Japanese astrophysicist **Kōryō Miura** developed
a folding pattern for deploying large structures in space.

The **Miura fold** (ミウラ折り) is a method of folding a flat surface
...
No sequential unfolding required.
No risk of a panel failing to deploy.

The Miura fold was used in the solar panels of Japan's Space Flyer Unit (1995).
It appears in maps designed to be opened and closed with one hand.
It has been proposed for airbags, medical stents, architectural facades.

The fold obeys a beautiful mechanical property:
...
This has profound engineering applications.

**Heart stents:** A flat mesh folded into a small cylinder for insertion,
then deployed to hold open a coronary artery.
The geometry of the fold must be precisely engineered
...
**Soft robotics:** Origami-inspired structures that can
change shape in response to pneumatic pressure,
used in grippers, locomotion systems, and medical devices.

**Architecture:** Building facades that adjust to light and temperature
using origami-inspired kinetic panels.

The mathematics of paper folding,
developed in the context of an ancient craft,
is now a branch of mechanical engineering.
...
The earliest known modular form is the **Sonobe unit**,
developed by Mitsunobu Sonobe in the late 1960s.
A single Sonobe unit is a simple parallelogram-based form.
But 12 units assemble into a small stellated dodecahedron.
...
**Why modular origami is mathematically deep:**

Each unit must satisfy local constraints:
the tabs must fit the pockets precisely,
the angles must be consistent,
the tension must be distributed evenly.
...
**Euler's formula** governs all of these:
